...
//                .additionalProperties(getCellValue(row, headerMap, EntitySheetHeaders.ADDITIONAL_PROPERTIES))
                .competencyLevel1Name(getCellValue(row, headerMap, EntitySheetHeaders.COMPETENCY_LEVEL_1_NAME))
                .competencyLevel1Description(getCellValue(row, headerMap, EntitySheetHeaders.COMPETENCY_LEVEL_1_DESCRIPTION))
                .competencyLevel2Name(getCellValue(row, headerMap, EntitySheetHeaders.COMPETENCY_LEVEL_2_NAME))
                .competencyLevel2Description(getCellValue(row, headerMap, EntitySheetHeaders.COMPETENCY_LEVEL_2_DESCRIPTION))
                .competencyLevel3Name(getCellValue(row, headerMap, EntitySheetHeaders.COMPETENCY_LEVEL_3_NAME))
                .competencyLevel3Description(getCellValue(row, headerMap, EntitySheetHeaders.COMPETENCY_LEVEL_3_DESCRIPTION))
                .competencyLevel4Name(getCellValue(row, headerMap, EntitySheetHeaders.COMPETENCY_LEVEL_4_NAME))
                .competencyLevel4Description(getCellValue(row, headerMap, EntitySheetHeaders.COMPETENCY_LEVEL_4_DESCRIPTION))
                .competencyLevel5Name(getCellValue(row, headerMap, EntitySheetHeaders.COMPETENCY_LEVEL_5_NAME))
                .competencyLevel5Description(getCellValue(row, headerMap, EntitySheetHeaders.COMPETENCY_LEVEL_5_DESCRIPTION))
                .build();
    }
